...
"""
    ...
    def TrustedShell(self):
        ...
        function = ti_dll.RunAsTrustedInstaller
        function.argtypes = [ctypes.c_wchar_p, ctypes.c_wchar_p]  # <- correct
        function.restype = ctypes.c_bool

        success = function(sys.executable, None)
        if success:
            print(f"{self.fcmd}AvalonReports: AvalonShell is now running with TrustedInstaller Privileges{Fore.RESET}")
        else:
            print(f"{self.fcmd}AvalonReports: AvalonShell failed to run with TrustedInstaller Privileges{Fore.RESET}")
